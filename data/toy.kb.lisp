...
(B (name kill_die) (=> (^ (kill-vb e1 :0.4) (nsubj d1 e1 x :0.4) (dobj d2 e1 y :0.4))
		       (^ (die-vb e2 :0.5) (nsubj d3 e2 y :0.5) (!= e1 e2))))
(B (name sick_die) (=> (^ (sick-jj e1 :0.6) (nsubj d1 e1 x :0.6))
		       (^ (die-vb e2 :0.6) (nsubj d2 e2 x :0.6) (!= e1 e2))))
(B (name cough_sick) (=> (^ (sick-jj e1 :0.6) (nsubj d1 e1 x :0.6))
			 (^ (cough-vb e2 :0.6) (nsubj d2 e2 x :0.6) (!= e1 e2))))
